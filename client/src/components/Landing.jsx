    ...
    <div className="landing">
      ...
      <footer className="footer">
        <div className="footer-content">
          ...
          <div className="footer-links">
            ...
            <div className="footer-section">
              ...
              <ul>
                <li>
                  <a href="https://github.com/gaulmt" target="_blank" rel="noopener noreferrer">
        ...
        <div className="footer-bottom">
          <p>© 2026 Code Net. Dự án của <a href="https://github.com/gaulmt" target="_blank" rel="noopener noreferrer">Nguyễn Đăng Dương</a></p>
        </div>
      </footer>
      ...
      {showProjects && authUser && (
        <ProjectsManager
          ...
          onJoinProject={(code) => {
            ...
            onJoinProject(displayName, code);
          }}
        />
      )}
    </div>
